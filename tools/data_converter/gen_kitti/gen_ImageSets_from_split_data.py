...
def gen_ImageSet_from_coop_split_data_train(ImageSets_path, split_data_path, sensor_view="vehicle"):
    split_datas = read_json(split_data_path)
    veh_test_file = ""
    veh_train_file = ""
    veh_val_file = ""
    ...
    frame_pairs = load_json('/home/yc/DataSet/retrain/train/cooperative/data_info.json')
